      ...
      <section class="we mt-5">
        ...
        <div class="row">
          <div class="col-md-6" v-for="(work, index) in workExperience" :key="index">
            <div class="card bg-white text-white mb-4 border border-black"> <!-- Added border classes -->
              <div class="card-body">
                <h5 class="card-title fs-4 text-success">{{ work.position }}</h5>
                <p class="card-text fs-4 text-success">{{ work.company }}</p>
                <p class="card-text fs-4 text-success">{{ work.date }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="we mt-5">
        ...
        <div class="row">
          <div class="col-md-6" v-for="(edu, index) in education" :key="index">
            <div class="card bg-white text-white mb-4 border border-black"> <!-- Added border classes -->
              <div class="card-body">
                <h5 class="card-title fs-4 text-success">{{ edu.degree }}</h5>
                <p class="card-text fs-4 text-success">{{ edu.school }}</p>
                <p class="card-text fs-4 text-success">{{ edu.date }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="we mt-3">
        ...
        <div class="row mx-auto">
          <div class="col-md-3 mx-auto" v-for="(skill, index) in skills" :key="index">
            <div class="card bg-white text-white border border-black" style="width: 200px; height: 200px;"> <!-- Added border classes -->
